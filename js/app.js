(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        const minusBtn1 = document.querySelector(".points__minus_1");
        const plusBtn1 = document.querySelector(".points__plus_1");
        const pointsV1 = document.querySelector(".points__value_1");
        const minusBtn2 = document.querySelector(".points__minus_2");
        const plusBtn2 = document.querySelector(".points__plus_2");
        const pointsV2 = document.querySelector(".points__value_2");
        const minusBtn3 = document.querySelector(".points__minus_3");
        const plusBtn3 = document.querySelector(".points__plus_3");
        const pointsV3 = document.querySelector(".points__value_3");
        const minusBtn4 = document.querySelector(".points__minus_4");
        const plusBtn4 = document.querySelector(".points__plus_4");
        const pointsV4 = document.querySelector(".points__value_4");
        let amount1 = 0;
        let amount2 = 0;
        let amount3 = 0;
        let amount4 = 0;
        ...
        const greatingTitle = document.getElementById("title");
        const greatingText = document.getElementById("text");
        calculate.addEventListener("click", (() => {
            const values = document.querySelectorAll(".points__value");
            let sum = 0;
            let count = 0;
            ...
            const interval = setInterval((() => {
                currentMean += .1 * (mean - currentMean);
                result.innerText = `${currentMean.toFixed(0)}`;
                if (Math.abs(currentMean - mean) < .01) {
                    clearInterval(interval);
                    result.innerText = `${mean.toFixed(0)}`;
                }
            }), 50);
            gsapWithCSS.to([ greatingText, greatingTitle ], {
                duration: 1,
                opacity: 0
            });
            gsapWithCSS.fromTo([ greatingText, greatingTitle ], {
                duration: 2,
                opacity: 0
            }, {
                duration: 1,
            ...
            if (mean <= 20) {
                greatingTitle.innerText = "Awful";
                greatingText.innerText = `Unfortunately, you scored lower than 20% of the people who have taken these tests. Keep practicing and you'll see improvements!`;
            } else if (mean <= 40) {
                greatingTitle.innerText = "Bad";
                greatingText.innerText = `Your score falls between 20% and 40% of the people who have taken these tests. Don't worry, with more practice, you can definitely improve.`;
            } else if (mean <= 60) {
                greatingTitle.innerText = "Good";
                greatingText.innerText = `Congratulations! Your score falls between 40% and 60% of the people who have taken these tests. Keep up the good work!`;
            } else if (mean < 100) {
                greatingTitle.innerText = "Great";
                greatingText.innerText = `You scored higher than 65% of the people who have taken these tests.`;
            } else {
                greatingTitle.innerText = "Amazing";
                greatingText.innerText = `Wow! Your score falls between 60% and 100% of the people who have taken these tests. You are doing an amazing job!`;
            }
        }));
    }));
    const tl = gsapWithCSS.timeline();
    tl.from([ ".result__circle", ".result__text" ], {
        duration: 2,
        opacity: 0
    }).from(".result", {
        duration: 2,
        borderRadius: "48% 38% 57% 43% / 36% 73% 27% 64%"
    }, 0).from(".column-left__title", {
        duration: 2,
        opacity: 0,
        x: "50%"
    }, "<1").from([ ".greating", ".column-right" ], {
        duration: 2,
        opacity: 0,
        y: "10%"
    }, "<1").to(".column-left__button", {
        duration: 2.5,
        width: "100%",
        opacity: 1,
        ease: "power4.out"
        ...
        opacity: 0,
        delay: .3
    }, "<1").from(".background-page__items li", {
        duration: .5,
        animation: "none"
    }, "<1");
    window["FLS"] = true;
